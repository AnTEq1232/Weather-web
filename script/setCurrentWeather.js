...
const setCurrentWeather = async (cityName) => {
    ...
    const currentWind = document.getElementById("windCurrent");
    ...
    currentWind.innerHTML = `Prędkość ${data.wind.speed} m/s<br>`;
    currentWind.innerHTML += `Kierunek ${data.wind.deg}°<br>`;
